...
static selectionParameter luaSerialProtocol = {
    ...
    0, // value
    "CRSF;Inverted CRSF;SBUS;Inverted SBUS;SUMD;DJI RS Pro;HoTT Telemetry;KISS Telemetry;MAVLink;DisplayPort;GPS",
    STR_EMPTYSPACE
};
...
static selectionParameter luaSerial1Protocol = {
    ...
    0, // value
    "Off;CRSF;Inverted CRSF;SBUS;Inverted SBUS;SUMD;DJI RS Pro;HoTT Telemetry;KISS Telemetry;Tramp;SmartAudio;DisplayPort;GPS",
    STR_EMPTYSPACE
};
#endif
